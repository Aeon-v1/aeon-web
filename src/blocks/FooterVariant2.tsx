...
export function FooterVariant2({
  ...
  return (
    <EditableSection id={id} as="footer" className="pb-6 pt-16 lg:pb-8 lg:pt-24 bg-background font-sans">
      <div className="px-4 lg:px-8 mx-auto max-w-7xl">
        ...
        <div className="border-t border-border mt-6 pt-6 md:mt-4 md:pt-8 lg:grid lg:grid-cols-10">
          ...
          <div className="mt-6 text-sm leading-6 text-muted-foreground whitespace-nowrap lg:mt-0 lg:row-[1/3] lg:col-[1/4]">
            <div>
              <Editable id={`${id}-copyright`} as="span" defaultText={copyrightText} propName="copyrightText" inline />
            </div>
            {copyrightLicense && (
              <div>
                <Editable id={`${id}-license`} as="span" defaultText={copyrightLicense} propName="copyrightLicense" inline />
              </div>
            )}
          </div>
        </div>
