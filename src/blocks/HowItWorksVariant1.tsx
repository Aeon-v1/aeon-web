      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          <Editable
            ...
            propName="headline"
            className="text-3xl md:text-5xl font-medium tracking-tighter text-[#EFEEEA]"
          />
          <Editable
            as="p"
            defaultText={subtext}
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Connecting line */}
          <div className="absolute top-8 left-8 right-8 h-[1px] bg-white/[0.08] hidden md:block" />
          ...
          <div className="grid gap-12 md:grid-cols-3 relative z-10">
            {steps.map((step, i) => (
              ...
              >
                <div className="h-16 w-16 rounded-full bg-[#1c1c1a] border border-white/[0.1] flex items-center justify-center text-xl font-mono text-[#EFEEEA] shadow-lg shadow-black/50">
                  0{i + 1}
                </div>
                <div>
                  <Editable
                    ...
                    className="text-xl font-medium text-[#EFEEEA] mb-3"
                  />
                  <Editable
                    as="p"
