      ...
      <div className="w-full max-w-5xl bg-background/70 backdrop-blur-xl border border-border rounded-full h-14 flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          <EditableButton
            ...
            whileTap={{ scale: 0.95 }}
            className="rounded-full bg-primary hover:bg-primary/90 px-5 py-2 text-xs font-semibold tracking-tight text-primary-foreground transition-all cursor-pointer"
          >
