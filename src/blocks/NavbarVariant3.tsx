...
export function NavbarVariant3({
  ...
  ctaText = "Get Started",
    ...
    return (
        <EditableSection id={id} as="header" className="sticky top-0 z-50 w-full">
            <nav
                data-state={menuState && 'active'}
                className="w-full px-2 bg-background/90 backdrop-blur-md border-b border-border">
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'max-w-4xl lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 py-2">
                        <div className="flex w-full justify-between lg:w-auto">
                            <div
                                ...
                                <Editable id={`${id}-logo`} as="p" defaultText={logoText} propName="logoText" className='font-semibold text-xl tracking-tighter text-foreground' inline />  
                            </div>
                        ...
                        <div className="absolute inset-0 m-auto hidden size-fit lg:block">
                            <ul className="flex gap-8 text-sm">
                                <li><Editable id={`${id}-link1`} as="span" defaultText={link1} propName="link1" className="text-muted-foreground hover:text-foreground block duration-150 cursor-pointer" inline /></li>
                                <li><Editable id={`${id}-link2`} as="span" defaultText={link2} propName="link2" className="text-muted-foreground hover:text-foreground block duration-150 cursor-pointer" inline /></li>
                                <li><Editable id={`${id}-link3`} as="span" defaultText={link3} propName="link3" className="text-muted-foreground hover:text-foreground block duration-150 cursor-pointer" inline /></li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-background in-data-[state=active]:block lg:in-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-border p-6 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:lg:bg-transparent">
                            <div className="lg:hidden">
                                <ul className="space-y-6 text-base">
                                    <li><Editable id={`${id}-mobile-link1`} as="span" defaultText={link1} propName="link1" className="text-muted-foreground hover:text-foreground block duration-150 cursor-pointer" inline /></li>
                                    <li><Editable id={`${id}-mobile-link2`} as="span" defaultText={link2} propName="link2" className="text-muted-foreground hover:text-foreground block duration-150 cursor-pointer" inline /></li>
                                    <li><Editable id={`${id}-mobile-link3`} as="span" defaultText={link3} propName="link3" className="text-muted-foreground hover:text-foreground block duration-150 cursor-pointer" inline /></li>
                                </ul>
                            </div>
